from data_helper import timeserie2image, read_files, download_uci_dataset, extract_uci_dataset, preprocess_data
import numpy as np
import pandas as pd
...
def main(args):
    ...
    model = BarlowTwins.load_from_checkpoint(f'experiments/{args.dirpath}/BT-PRETEXT-{args.filename}.ckpt')
    ...
    checkpoint_callback = ModelCheckpoint(monitor='val_loss', mode='min', dirpath='experiments'/args.dirpath, filename=f'BT-DOWNSTREAM-{args.filename}')
